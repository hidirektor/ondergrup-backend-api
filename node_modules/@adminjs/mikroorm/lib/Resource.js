...
export class Resource extends BaseResource {
    ...
    async count(filter) {
        return this.orm.em.fork().getRepository(this.model).count(convertFilter(filter));
    }
    ...
    async create(params) {
        ...
        const returnedParams = flat.flatten(wrap(instance).toJSON());
    ...
    async update(pk, params = {}) {
        ...
        const returnedParams = flat.flatten(wrap(updatedInstance).toJSON());
        return returnedParams;
    }
    async delete(id) {
        await this.orm.em
