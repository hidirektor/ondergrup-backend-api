...
module.exports = {
        ...
        try {
            ...
            connectionPool.getConnection((err, connection) => {
                ...
                connection.query(checkSql, (err, results) => {
                    if(err) {
                        connection.release();
                        console.error('Olmayan makineye veri yüklenemez !');
                    ...
                    if(results.length === 0) {
                        ...
                        res.status(400).json({ message: 'Bu makine zaten var !'});
                    }
                });
            });
        } catch (err) {
    ...
    updateMachineData: async (req, res, next) => {
        ...
        try {
            const dataArray = JSON.parse(machineData);
